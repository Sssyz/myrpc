...
class RpcHeader :
 ...
 public:
  ...
  void set_methond_name(const std::string& value);
  void set_methond_name(std::string&& value);
  void set_methond_name(const char* value);
  void set_methond_name(const void* value, size_t size);
  std::string* mutable_methond_name();
  std::string* release_methond_name();
  void set_allocated_methond_name(std::string* methond_name);
  private:
  const std::string& _internal_methond_name() const;
  void _internal_set_methond_name(const std::string& value);
...
inline void RpcHeader::clear_methond_name() {
  methond_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RpcHeader::methond_name() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.methond_name)
  return _internal_methond_name();
}
inline void RpcHeader::set_methond_name(const std::string& value) {
  _internal_set_methond_name(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.methond_name)
}
inline std::string* RpcHeader::mutable_methond_name() {
  // @@protoc_insertion_point(field_mutable:mprpc.RpcHeader.methond_name)
  return _internal_mutable_methond_name();
}
inline const std::string& RpcHeader::_internal_methond_name() const {
  return methond_name_.GetNoArena();
}
inline void RpcHeader::_internal_set_methond_name(const std::string& value) {
  
  methond_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RpcHeader::set_methond_name(std::string&& value) {
  
  methond_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpc.RpcHeader.methond_name)
}
inline void RpcHeader::set_methond_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  methond_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mprpc.RpcHeader.methond_name)
}
inline void RpcHeader::set_methond_name(const void* value, size_t size) {
  
  methond_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpc.RpcHeader.methond_name)
}
inline std::string* RpcHeader::_internal_mutable_methond_name() {
  
  return methond_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RpcHeader::release_methond_name() {
  // @@protoc_insertion_point(field_release:mprpc.RpcHeader.methond_name)
  
  return methond_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RpcHeader::set_allocated_methond_name(std::string* methond_name) {
  ...
  methond_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), methond_name);
  // @@protoc_insertion_point(field_set_allocated:mprpc.RpcHeader.methond_name)
}
